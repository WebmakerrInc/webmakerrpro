                        ...
                        'schema'          => [
                            ...
                            'currency_position_grid' => [
                                ...
                                'schema'          => [
                                    'label'             => [
                                        'type'  => 'html',
                                        'value' => '<span class="setting-label">' . __('Currency Position', 'fluent-cart') . '</span>
                                                            <div class="form-note">' . __("Select where the currency symbol should appear relative to the amount.", 'fluent-cart') . '</div>'
                                    ],
                                    'currency_position' => [
                                        'wrapperClass' => 'col-span-2 flex items-center',
                                        "label"        => '',
                                        ...
                                        "options"      => [
                                            [
                                                "label" => __('Before (eg: $100)', 'fluent-cart'),
                                                "value" => 'before',
                                            ],
                                            [
                                                "label" => __('After (eg: 100$)', 'fluent-cart'),
                                                "value" => 'after',
                                            ],
                                        ],
                                        "value"        => "before"
