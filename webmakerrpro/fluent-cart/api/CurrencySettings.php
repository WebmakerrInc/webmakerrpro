...
class CurrencySettings
{
    ...
    public static function get(string $key = '')
    {
        ...
        $settings = [
            ...
            'thousand_separator' => static::getValue($settings, 'thousand_separator', ','),
    ...
    public static function getFormattedPrice($amount, $currencyCode = null, $asList = false, $showDecimal = true)
    {
        ...
        $decimeter = Arr::get($settings, 'decimal_separator', 'dot') === 'dot' ? '.' : ',';
        $separator = Arr::get($settings, 'thousand_separator', 'comma') === 'dot' ? '.' : ',';
