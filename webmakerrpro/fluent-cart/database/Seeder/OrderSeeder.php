    ...
    public static function seed($count, $assoc_args = [])
    {
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            foreach ($randomizeProduct as $key => $productIndex) {
                ...
                error_log(print_r(['payment_type' => $variant['payment_type'], 'id' => $variant['id']], true));
            ...
            if ($paymentStatus === 'paid') {
                ...
                $totalPaid = $totalAmount;
                $refundPercentage = rand(20, 30) / 100;
                $totalRefund = round($totalPaid * $refundPercentage, 2);
            } elseif ($paymentStatus === 'partially_paid') {
                $paymentPercentage = rand(50, 60) / 100;
