...
class CartSummaryRender
{
        ...
        <?php endif; ?>
                <div class="fct_checkout_form_section">
                    <div class="fct_form_section_header">
                        <div data-fluent-cart-checkout-cart-items-toggle class="fct_toggle_content">
                            <h4><?php echo __('Order summary', 'fluent-cart'); ?></h4>
                            <div class="fct_toggle_icon">
                        ...
                        <div class="fct_summary_toggle_total">
                            <span class="value" data-fluent-cart-checkout-estimated-total>
                                <?php 
    ...
    public function showManualDiscount()
    {
        ...
        ?>
        <li>
            <span class="fct_summary_label"> <?php echo esc_html($title); ?></span>
            <span class="fct_summary_value" data-fluent-cart-checkout-manual-discount>
    ...
    public function showCouponField()
    {
        ...
        <div class="fct_coupon">
            ...
            <div class="fct_coupon_field" data-fluent-cart-checkout-page-coupon-container>
                <span class="fct_coupon_icon">
                ...
                <div data-fluent-cart-checkout-page-form-input-wrapper class="fct_coupon_input_wrapper">
                    <input 
                        ...
                        type=text 
                        name=coupon 
                        placeholder="<?php _e('Apply Here', 'fluent-cart'); ?>"
                        data-required=no 
                        data-type=input 
                        id=coupon 
                        checked=no
