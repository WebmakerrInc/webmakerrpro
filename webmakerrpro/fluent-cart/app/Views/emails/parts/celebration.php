...
<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="text-align:center;margin-bottom:32px; background-color: <?php echo $palette['bg']; ?>; padding: 20px; border-radius: 8px; border: 0px solid <?php echo $palette['text']; ?>;">
    <tbody>
    <tr>
        <td>
            <h1 style="color: <?php echo $palette['text']; ?>; font-size: 20px; margin: 0;">
                <?php echo $text; ?>
            </h1>
        </td>
    </tr>
