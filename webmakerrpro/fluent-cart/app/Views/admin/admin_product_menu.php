<div class="fc-admin-product-header">
    <div>
        <div class="fc-admin-product-info">
        ...
        <ul class="fc-admin-product-menu">
            <?php foreach ($menu_items as $itemSlug => $menu_item): ?>
                <li class="fc_menu_<?php echo esc_attr($itemSlug); ?> <?php echo ($active == $itemSlug) ? 'active-menu' : ''; ?>">
                    <a href="<?php echo esc_url($menu_item['link']); ?>">
                        <?php echo esc_attr($menu_item['label']); ?>
                        <?php echo $active === $itemSlug?>
                    </a>
                </li>
            <?php endforeach; ?>
        </ul>
    ...
    <div id="fc-admin-product-header-buttons"></div>
</div>
