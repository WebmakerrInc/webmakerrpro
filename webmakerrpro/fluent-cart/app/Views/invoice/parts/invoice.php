...
<table border='1' style='width: 100%; border-collapse: collapse;'>
    ...
    <?php
        foreach ($order->order_items as $item) {
            ...
            echo App::view()->make('invoice.parts.table_row',[
                'product' => $product,
                'item' => $item,
            ]);
        }
...
<table style='width: 100%; margin-top: 20px;'>
    <tr>
        ...
        <td style='text-align: right;'><?php echo Helper::toDecimal($subtotal)?></td>
    </tr>
    <tr>
        <td style='text-align: right; font-weight: bold;'>Discount:</td>
        <td style='text-align: right;'>- <?php echo Helper::toDecimal($subtotal-$total)?> </td>
    </tr>
    <tr>
        <td style='text-align: right; font-weight: bold;'>Total:</td>
        <td style='text-align: right; font-size: 16px;'>  <?php echo Helper::toDecimal($total)?></td>
    </tr>
</table>
