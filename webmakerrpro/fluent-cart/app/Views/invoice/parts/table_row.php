...
<tr>
    ...
    <td style="text-align: center; padding-left: 8px; padding-right: 8px;"><?php echo Helper::toDecimal($item->unit_price); ?></td>
    <td style="text-align: center; padding-left: 8px; padding-right: 8px;"><?php echo Helper::toDecimal($item->subtotal); ?></td>
</tr>
