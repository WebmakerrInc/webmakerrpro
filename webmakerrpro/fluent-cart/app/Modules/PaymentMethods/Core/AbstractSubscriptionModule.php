...
abstract class AbstractSubscriptionModule
{
    ...
    {
        throw new \Exception(__('Subscription fetching not available for this method!', 'fluent-cart'), 404);
    }
    ...
    {
        throw new \Exception(__('No valid payment method to update!', 'fluent-cart'), 404);
    }
    ...
    {
        throw new \Exception(__('No valid payment method to switch!', 'fluent-cart'), 404);
    }
    ...
    {
        throw new \Exception(__('No valid payment method to reactivate!', 'fluent-cart'), 404);
    }
    ...
    {
        throw new \Exception(__('No valid payment method to pause!', 'fluent-cart'), 404);
    }
    ...
    {
        throw new \Exception(__('No valid payment method to resume!', 'fluent-cart'), 404);
    }
    ...
    public function cancel($vendorSubscriptionId, $args = [])
    {
        return new \WP_Error(
            'not_implemented',
            __('Cancel subscription is not implemented for this payment method.', 'fluent-cart')
        );
    }
    ...
    {
        throw new \Exception(__('No valid payment method to cancel!', 'fluent-cart'), 404);
    }
    ...
    public function reSyncSubscriptionFromRemote(Subscription $subscriptionModel)
    {
        return new \WP_Error(
            'not_implemented',
            __('Re-sync subscription from remote is not implemented for this payment method.', 'fluent-cart')
        );
    }
}
