...
class SubscriptionManager
{
    ...
    public function pauseSubscription($data, $order, $subscription)
    {
        if (!current_user_can('manage_options')) {
            throw new \Exception(__('Sorry, You do not have permission to pause subscription!'));
        }
        ...
        if (!$vendorSubscriptionId || !$subscription) {
            throw new \Exception(__('Sorry, Subscription not found!', 'fluent-cart'));
        }
    ...
    {
        if (!current_user_can('manage_options')) {
            throw new \Exception(__('Sorry, You do not have permission to resume subscription!'));
        }
        ...
        if (!$vendorSubscriptionId || !$subscription) {
            throw new \Exception(__('Sorry, Subscription not found!'));
        }
