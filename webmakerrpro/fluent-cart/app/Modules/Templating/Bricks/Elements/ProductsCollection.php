...
class ProductsCollection extends Custom_Render_Element
{
    ...
    protected $cssRoot = '.fc-products-wrapper-inner .fc-products-container';
...
//        ];
    ...
    public function render()
    {
        ...
        $wrapperAttributes = [
            'class'                                  => 'fc-products-wrapper-inner mode-grid fc-full-container-width',
        ...
        echo '<div class="fc-products-wrapper" data-fluent-cart-shop-app data-fluent-cart-product-wrapper>';
        ?>
    <div <?php RenderHelper::renderAtts($wrapperAttributes); ?>>
        <?php
        echo '<div data-fluent-cart-shop-app-product-list class="fc-products-container grid-columns-' . esc_attr($columns) . '">';
