    ...
    public function set_controls()
    {
        ...
        $this->controls['colorSwatchBorder'] = [
            ...
            'css'   => [
                [
                    'property' => 'border',
                    'selector' => '.bricks-fct-variation-swatches .fc-product-variant-item',
                ],
            ],
        ];
        ...
        $this->controls['colorSwatchActiveBorder'] = [
            ...
            'css'   => [
                [
                    'property' => 'border',
                    'selector' => '.bricks-fct-variation-swatches .fc-product-variant-item.selected',
                ],
            ],
        ];
        ...
        $this->controls['labelSwatchPadding'] = [
            ...
            'css'         => [
                [
                    'property' => 'padding',
                    'selector' => '.bricks-fct-variation-swatches .fc-product-variant-item .fc-product-variant-title',
                ],
            ],
            'placeholder' => [
                'top'    => '0',
        ...
        $this->controls['labelSwatchActiveTypography'] = [
            ...
            'css'   => [
                [
                    'property' => 'font',
                    'selector' => '.bricks-fct-variation-swatches .fc-product-variant-item.selected .fc-product-variant-title',
                ],
            ],
        ];
        ...
        $this->controls['imageSwatchWidth'] = [
            ...
            'css'         => [
                [
                    'property' => 'width',
                    'selector' => '.bricks-fct-variation-swatches .fc-product-variant-item img',
                ],
            ],
            'placeholder' => '32px',
        ];
        ...
        $this->controls['quantityBorder'] = [
            ...
            'css'   => [
                [
                    'selector' => '.fc-product-quantity .fc-quantity-input',
                    'property' => 'border',
                ],
                [
                    'selector' => '.fc-product-quantity .fc-quantity-decrease-button',
                    'property' => 'border',
                ],
                [
                    'selector' => '.fc-product-quantity .fc-quantity-increase-button',
                    'property' => 'border',
                ],
            ],
        ];
        ...
        $this->controls['buttonMargin'] = [
            ...
            'css'   => [
                [
                    'selector' => '.fc-product-buttons-wrap .fluent-cart-add-to-cart-button',
                    'property' => 'margin',
                ],
            ],
        ];
        ...
        $this->controls['directButtonMargin'] = [
            ...
            'css'   => [
                [
                    'selector' => '.fc-product-buttons-wrap .fluent-cart-direct-checkout-button',
                    'property' => 'margin',
                ],
            ],
        ];
