...
class ProductGallery extends Element
{
    ...
    public function set_controls()
    {
        ...
        $this->controls['itemWidth'] = [
            ...
            'css'         => [
                [
                    'selector' => '.fc-gallery-thumb-controls .fc-gallery-thumb-control-button',
                    'property' => 'width',
                ]
            ],
            'placeholder' => '70px',
        ...
        $this->controls['gap'] = [
            ...
            'css'         => [
                [
                    ...
                    'selector' => '.fc-gallery-thumb-controls',
                    'property' => 'gap',
                ]
            ],
            'placeholder' => '30px',
        ...
        $this->controls['thumbnailOpacity'] = [
            ...
            'css'         => [
                [
                    'selector' => '.fc-gallery-thumb-controls .fc-gallery-thumb-control-button:not(.active) img',
                    'property' => 'opacity',
                ]
            ],
            'placeholder' => '0.3',
        ...
        $this->controls['thumbnailActiveOpacity'] = [
            ...
            'css'   => [
                [
                    'selector' => '.fc-gallery-thumb-controls .fc-gallery-thumb-control-button.active',
                    'property' => 'opacity',
                ]
            ],
        ];
