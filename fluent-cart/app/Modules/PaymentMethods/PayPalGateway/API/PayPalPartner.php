...
class PayPalPartner
{
    ...
    public function makeMerchantRequest($endpoint, $sellerAccessToken, $method = 'GET')
    {
        ...
        $args = [
            ...
            'method'    => $method,
            'sslverify' => false // remove in production
        ];
    ...
    private function sendTokenRequest($url, $payload, $sharedId)
    {
        ...
        curl_setopt($ch, CURLOPT_USERPWD, $sharedId . ':'); // Shared ID with empty password
...
//                                    'VAULT'
            ...
            'partner_config_override' => [
                ...
                'return_url_description' => 'Return to WebmakerrPro',
    ...
    public function getRemoteAuthenticator($payload, $mode)
    {
        ...
        $response = wp_remote_post(
            ...
            [
                'method'    => 'POST',
                'body'      => json_encode($payload), // Send the payload as JSON
                'headers'   => [
                    'Content-Type' => 'application/json'  // Set content type to JSON
                ],
                'sslverify' => false //remove on production
            ]
        );
