...
class PayPalPartnerRenderer
{
    ...
    {
        if (!$mode) {
            echo '<div class="fct_message fct_message_error">' . esc_html(__('Invalid PayPal payment mode. Please try configuring paypal payment gateway again expected mode test or live !')) . '</div>';
            die();
        }
