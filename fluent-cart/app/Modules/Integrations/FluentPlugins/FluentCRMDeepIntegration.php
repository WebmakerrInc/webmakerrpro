...
class FluentCRMDeepIntegration
{
    ...
    public function addAdvancedFilterOptions($groups)
    {
        ...
        $groups['fluent_cart'] = [
            'label'    => __('WebmakerrPro', 'fluent-cart'),
            'value'    => 'fluent_cart',
    ...
    public function getStatsHtml($customer)
    {
        $stats = [
            ...
            [
                ...
                'value' => $customer->first_purchase_date ? date('F j, Y', strtotime($customer->first_purchase_date)) : 'N/A'
            ],
            [
                'title' => __('Last Purchased: ', 'fluent-cart'),
                'value' => $customer->last_purchase_date ? date('F j, Y', strtotime($customer->last_purchase_date)) : 'N/A'
            ],
        ];
        ...
        foreach ($formattedItems as $formattedItem) {
            ...
            $html .= '<li>' . $countHtml . $formattedItem['post_title'] . ' - <span style="font-style: italic;">' . $formattedItem['title'] . '</span> (' . date('F j, Y', strtotime($formattedItem['created_at'])) . ')</li>';
        }
