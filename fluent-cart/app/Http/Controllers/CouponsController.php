    ...
    public function create(CouponRequest $request)
    {
        ...
        if ($createdId) {
            \fluent_cart_add_log(
                ...
                sprintf(__('Coupon "%s" created by %s', 'fluent-cart'), Arr::get($isCreated, 'data.title', ''), wp_get_current_user()->display_name ?? 'FCT-BOT'),
                'success',
                [
                    'module_name' => 'coupon',
    ...
    public function update(CouponRequest $request, $id)
    {
        ...
        if ($updatedId) {
            \fluent_cart_add_log(
                ...
                sprintf(__('Coupon "%s" updated by %s', 'fluent-cart'), Arr::get($isUpdated, 'data.title', ''), wp_get_current_user()->display_name ?? 'FCT-BOT'),
                'info',
                [
                    'module_name' => 'coupon',
