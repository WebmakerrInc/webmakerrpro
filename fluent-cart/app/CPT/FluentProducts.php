...
class FluentProducts
{
    ...
    public function register()
    {
        ...
        add_action('admin_enqueue_scripts', function () {
            ...
            wp_register_script('fluent-products-inline-js', '', [], '', true);
...
//        });
    ...
    {
        $custom_js = <<<JS
            console.log('doc ready - editor context');
...
//            'rest_base'             => $urlSlug, // Optional: customize REST API base
    ...
    public function customizeTaxonomyScreen()
    {
        ...
        add_action('in_admin_header', function () {
            ?>
            <div style="margin-left: -20px;" class="fc_taxonomy_menu" id="fca_admin_menu_holder">
