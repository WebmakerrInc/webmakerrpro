...
class EditorShortCodeHelper
{
    ...
    public static function getButtons()
    {
        ...
        return [
            'View Order' => '<a href="' . $url . '/wp-admin/admin.php?page=webmakerrpro#/orders/{{order.id}}/view" style="background-color: green; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 5px;">View Order</a>'
        ];
    }
}
