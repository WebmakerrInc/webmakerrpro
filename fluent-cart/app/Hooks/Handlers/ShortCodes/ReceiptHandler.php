...
//        ]);
        ...
        $footerContent = "<div style='padding: 15px; text-align: center; font-size: 16px; color: #2F3448;'>Powered by <a href='https://webmakerrpro.com' style='color: #017EF3; text-decoration: none;'>". __('WebmakerrPro', 'fluent-cart') ."</a></div>";
