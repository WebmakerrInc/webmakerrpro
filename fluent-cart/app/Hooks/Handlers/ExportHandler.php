...
class ExportHandler
{
    ...
    public function exportOrders()
    {
        ...
        $writer->openToBrowser('orders-export-' . date('Y-m-d_H:i') . '.csv');
    ...
    public function exportRepeatCustomers()
    {
        ...
        $writer->openToBrowser('repeat-customers-export-' . date('Y-m-d_H:i') . '.csv');
    ...
    public function exportProducts()
    {
        ...
        $writer->openToBrowser('products-export-' . date('Y-m-d_H:i') . '.csv');
        ...
        foreach ($products as $product) {
            ...
            $rowData = [
                ...
                date('Y-m-d', strtotime($product->post_date)),
            ];
            $writer->addRow(WriterEntityFactory::createRowFromArray($rowData));
        }
        $writer->close();
