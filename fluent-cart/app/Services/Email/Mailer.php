...
class Mailer
{
    ...
    public function wrapWithFooter($content): string
    {
        ...
        if (!App::isProActive()) {
            $cartFooter = "<div style='background: #fff;padding: 32px; text-align: center; font-size: 16px; color: #2F3448;'>" . esc_html__('Powered by', 'fluent-cart') . " <a href='https://webmakerrpro.com' style='color: #017EF3; text-decoration: none;'>" . esc_html__('WebmakerrPro', 'fluent-cart') . "</a></div>";
            $content .= $cartFooter;
        }
        return $content;
