...
class Mailer
{
    ...
    public function wrapWithFooter($content): string
    {
        ...
        if (!App::isProActive()) {
            $cartFooter = "<div style='background: #fff;padding: 32px; text-align: center; font-size: 16px; color: #2F3448;'>Powered by <a href='https://webmakerrpro.com' style='color: #017EF3; text-decoration: none;'>WebmakerrPro</a></div>";
            $content .= $cartFooter;
        }
        return $content;
