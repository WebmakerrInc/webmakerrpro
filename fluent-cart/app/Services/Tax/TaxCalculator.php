...
class TaxCalculator
{
    ...
    protected function loadRates($country, $state = null, $postCode = null, $taxClassIds = [])
    {
    ...
    public static function calculateTaxForCart(Cart $cart, $country = '', $state = null, $postCode = null): TaxCalculator
    {
//        $country = 'BD';
//        $state = 'BD-05';
//        $country = 'US';
//        $state = 'AL';
        $instance = new self($cart->cart_data, $country, $state, $postCode);
