...
class CartRenderer
{
    ...
    public function renderItems()
    {
        ...
        <div class="fc-cart-drawer-content-wrapper" data-fluent-cart-cart-content-wrapper>
            <?php $this->renderList(); ?>
        </div>
    ...
    {
        $placeholderImage = Arr::get($this->cartItem, 'featured_media') ?? Vite::getAssetUrl('images/placeholder.svg');
        ?>
        ...
        <div class="fc-cart-item-image">
            <a href="<?php echo esc_url($this->url); ?>">
                <img src="<?php echo esc_url($placeholderImage); ?>"
                     ...
                     alt="<?php echo esc_attr(Arr::get($this->cartItem, 'title', '')); ?>"/>
            </a>
    ...
    public function renderTitles()
    {
        ...
        >
            <a href="<?php echo esc_url($this->url) ?>" data-fluent-cart-cart-list-item-title-url>
    ...
    public function renderItemPrice()
    {
        ...
        <div class="fc-cart-item-price">
            <?php echo esc_html__('Price', 'fluent-cart'); ?>:
    ...
    public function renderTotal()
    {
        ...
        <div data-fluent-cart-cart-total-wrapper="" class="fc-cart-total-wrapper">
            <span><?php echo esc_html__('Total', 'fluent-cart'); ?>:</span>
            <span data-fluent-cart-cart-total-price="">
                <?php echo (CartCheckoutHelper::make())->getItemsAmountSubtotal(true, true); ?>
            </span>
        </div>
    ...
    public function renderCheckoutButton()
    {
        ...
        <a class="checkout-button"
           href="<?php echo esc_attr($this->storeSettings->getCheckoutPage()); ?>">
            <?php echo esc_html__('Go to Checkout', 'fluent-cart'); ?>
        </a>
    ...
    public function renderViewCartButton()
    {
        ...
        <a class="view-cart-button"
           href="<?php echo esc_attr($this->storeSettings->getCartPage()); ?>">
            <?php echo esc_html__('View Cart', 'fluent-cart'); ?>
        </a>
    ...
    { ?>
        <div class="fluent-cart-cart-empty-content-text">
            ...
            <a href="<?php echo esc_url($this->storeSettings->getShopPage() ?? ''); ?>">
