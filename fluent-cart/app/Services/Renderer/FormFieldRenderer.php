...
class FormFieldRenderer
{
        ...
        <div <?php RenderHelper::renderAtts($wrapperAttributes); ?>>
            ...
            <?php if (!empty($label)) : ?>
                <div class="fct_form_section_header">
                    <h4 class="fct_form_section_header_label">
    ...
    private function renderSingleLineInputField($fieldData)
    {
        ...
        $inputAttributes = array_filter([
            ...
            'required'     => Arr::get($fieldData, 'required', '') === 'yes' ? 'required' : '',
            'disabled'     => Arr::get($fieldData, 'disabled', '') === true ? 'disabled' : '',
            'aria-label'   => Arr::get($fieldData, 'aria-label', ''),
        ]);
        ...
        $wrapperAttributes = array_filter([
            ...
            'id'    => 'fct_wrapper_' . Arr::get($fieldData, 'id', '')
        ]);
        ...
        <div <?php RenderHelper::renderAtts($wrapperAttributes); ?>>
            ...
            ?>
            <?php if (!empty($label)) : ?>
                <label for="<?php echo esc_attr(Arr::get($fieldData, 'id', '')) ?>" class="fct_input_label fct_input_label_<?php echo esc_attr($type) ?>">
                    <?php echo wp_kses_post($label) ?>
                </label>
            <?php endif; ?>
    ...
    private function renderTextareaField($fieldData)
    {
        ...
        <div <?php RenderHelper::renderAtts($wrapperAttributes); ?>>
            ...
            ?>
            <?php if (!empty($label)) : ?>
                <label for="<?php echo esc_attr(Arr::get($fieldData, 'id', '')) ?>"
