...
//    ];
    ...
    public function getAdminOrderLink($accessor, $code = null)
    {
        ...
        return admin_url('admin.php?page=webmakerrpro#/orders/' . Arr::get($this->order, 'id') . '/view');
    }
    ...
    public function getAdminOrderAnchorLink($accessor, $code = null, $conditions = [])
    {
        ...
        $url = admin_url('admin.php?page=webmakerrpro#/orders/' . Arr::get($this->order, 'id') . '/view');
