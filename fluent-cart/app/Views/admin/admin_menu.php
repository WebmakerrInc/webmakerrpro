...
$brandLabel = esc_html__('WebmakerrPro', 'fluent-cart');
...
<div class="fca_admin_menu_wrap fca_global_menu_wrap fluent-cart-admin-pages">
    <div class="fca_admin_menu_row">
        <div class="fca_admin_logo_wrap">
            <a aria-label="<?php echo esc_attr($brandLabel); ?>"
               title="<?php echo esc_attr($brandLabel); ?>"
               href="<?php echo esc_url(admin_url('admin.php?page=webmakerrpro#/')); ?>">
                <span class="fca_admin_logo_text"><?php echo $brandLabel; ?></span>
            </a>
                ...
                <?php if (PermissionManager::hasPermission(["store/settings", 'store/sensitive'])): ?>
                    <div class="fc_admin_settings_btn_wrap">
                        <a class="fc_admin_settings_btn"
                           href="<?php echo admin_url('admin.php?page=webmakerrpro#/settings/store-settings/') ?>">
