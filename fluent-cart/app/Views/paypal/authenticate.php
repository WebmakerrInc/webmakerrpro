...
<head>
    ...
    <title>WebmakerrPro PayPal Authentication</title>
</head>
<body>
<script>
...
<div class="fluent_cart_paypal_authenticator_main">
    <div class="fluent_cart_paypal_authenticator_header">
        <div class="fc-logo-wrap">WebmakerrPro</div>
    </div>
    ...
    <div class="fluent_cart_paypal_authenticator_content">
        ...
        <?php if(!$url) :?>
            <p class="fluent_cart_paypal_authenticator_alert">
                ...
                Connect URL is not available for order mode <?php echo $mode; ?>. Please try again or contact WebmakerrPro support.
            </p>
        <?php endif ?>
        ...
        <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 4px;">
            ...
            <span class="fluent_cart_authenticate_mode fluent_cart_authenticate_<?php echo $mode; ?>">
                <?php echo $mode; ?>
            </span>
        </div>
        ...
        <?php if ($url) : ?>
            ...
            >
                Connect PayPal with WebmakerrPro
...
<script id="paypal-js" src="<?php echo $scriptJs;?>" PayPal-Partner-Attribution-Id="FLUENTCART_SP_PPCP" ></script>
</body>
</html>
