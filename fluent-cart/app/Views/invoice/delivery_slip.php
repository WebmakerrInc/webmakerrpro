                        ...
                        <tr style="width: 100%;">
                            <td style="width: 50%; border: none !important;">
                                ...
                                <table style="font-size: 14px; font-weight: 400; width: 100%; border-collapse: collapse; border: 0; margin-bottom: 20px;">
                                    <tr>
                                        <td style="color: #565865; border: 0; width: 100px; padding-top: 5px; padding-bottom: 5px; "><?php echo __('Order ID:', 'fluent-cart') ?></td>
                                    ...
                                    <tr>
                                        <td style="color: #565865; border: 0; width: 100px; padding-top: 5px; padding-bottom: 5px;"><?php echo __('Date:', 'fluent-cart') ?></td>
                    ...
                    <table style="width: 100%; border: none !important;margin-top: 20px;">
                        <tr style="width: 100%;">
                            <td style="text-align: right;padding-right: 4px;">
                                <a href="https://webmakerrpro.com" style="padding: 10px 20px;display:inline-block;text-decoration: none;border-radius: 8px;font-weight: 600;font-size: 14px;text-align: center;background: linear-gradient(135deg, #3b82f6, #2563eb);color: white;">
                                    Leave a Review
                                </a>
                            </td>
