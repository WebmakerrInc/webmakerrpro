...
class CheckoutApi
{
    ...
    public static function placeOrder(array $data, $fromCheckout = false)
    {
        ...
        $orderData = OrderService::groupSanitizedData($data);
        ...
        $checkoutProcessor = new CheckoutProcessor($cartCheckoutHelper->getItems(), [
            ...
            'tax_id'                    => Arr::get($data, 'billing_tax_id', 0),
        ]);
        ...
        do_action('fluent_cart/checkout/prepare_other_data', ['cart' => $cart, 'order' => $createdOrder]);
