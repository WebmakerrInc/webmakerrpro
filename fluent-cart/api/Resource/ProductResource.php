        ...
        if (count($variants) > 0) {
            ...
            if ($variationType === 'simple') {
                ...
                $variantData = [
                    ...
                    'item_price'      => Arr::get($variant, 'item_price') * 100,
                    'compare_price'   => Arr::get($variant, 'compare_price') * 100,
                    'other_info'      => $otherInfo,
                    'manage_cost'     => Arr::get($variant, 'manage_cost', 'no'),
                    'item_cost'       => Arr::get($variant, 'item_cost') * 100,
