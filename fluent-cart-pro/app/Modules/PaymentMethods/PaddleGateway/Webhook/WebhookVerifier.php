...
class WebhookVerifier
{
    ...
    {
        if (empty($secretKey)) {
            new \WP_Error('paddle_webhook_secret_missing', __('Paddle webhook secret is missing', 'fluent-cart'));
        }
    ...
    public function verifyFromRequest(array $headers, string $rawBody): bool
    {
        ...
        if (empty($signature)) {
            new \WP_Error('paddle_webhook_signature_invalid', __('Invalid webhook signature', 'fluent-cart'));
        }
