...
class Price
{
    ...
    public static function getOrCreatePaddleRecurringPrice($data = [])
    {
        ...
        if (Arr::get($data, 'bill_times') > 0) {
            $description .= ' - ' . __('For', 'fluent-cart') . ' ' . Arr::get($data, 'bill_times') . ' ' . __('Times', 'fluent-cart');
        } else {
            $description .= ' - ' . __('Until Cancel', 'fluent-cart');
        }
        ...
        if (Arr::get($data, 'trial_days') > 0) {
            ...
            $description .= ' - ' . __('Trial', 'fluent-cart') . ' ' . Arr::get($data, 'trial_days') . ' ' . __('Days', 'fluent-cart');
